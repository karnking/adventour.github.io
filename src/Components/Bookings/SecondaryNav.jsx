...
const SecondaryNav = () => {
  ...
  return (<>
    <C.Button colorScheme='cyan' size="sm" borderRadius={0} zIndex={4} position={'fixed'}  bg="cyan.300" mt='70px' w="100vw" onClick={onOpen}>
      <TriangleDownIcon color='white' />
    </C.Button>
    <C.Drawer placement={'top'} mt='70px' onClose={onClose} isOpen={isOpen}>
      <C.DrawerOverlay />
      <C.DrawerContent>
